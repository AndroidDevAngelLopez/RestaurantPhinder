...
android {
    namespace = "com.complexsoft.location.data"
    compileSdk = 34

    defaultConfig {
        minSdk = 27
        //buildConfigField("String", "apiKey", "AIzaSyBJStR2-XAFQQcoYF3b04yinBraWAIAO1U")
...
dependencies {
    ...
    //GoogleMaps
    implementation(GoogleMapsLibraries.play_services_location)
